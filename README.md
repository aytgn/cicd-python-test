...
3. Başlık (Title) kısmına şu formatta komutunuzu yazın: `işlem: sayı1, sayı2`.
...
* **Kalite Kontrol:** `main` dalına gelen her kod otomatik olarak test edilir.
* **Otomatik Dağıtım:** Sadece testleri geçen sağlam kodlar `stable` dalına aktarılır.
